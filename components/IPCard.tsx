...
const IPCard: React.FC<IPCardProps> = ({ item, categoryName, onClick }) => (
  <div className="group flex flex-col gap-3 md:gap-6 cursor-pointer" onClick={onClick}>
    ...
    <div className="text-center">
      <h3 className="text-xl md:text-2xl font-serif font-medium text-slate-900 mb-0.5 md:mb-1 group-hover:text-blue-600 transition-colors">
        {item.name}
      </h3>
      <p className="text-sm font-light text-slate-500 mb-2 md:mb-3 tracking-wide">{categoryName}</p>
    </div>
  </div>
);
